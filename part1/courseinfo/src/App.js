...
const Content = (props) => {
  return (
    <div>
      <Part exercise={props.exercises1} part={props.part1}></Part>
      <Part exercise={props.exercises2} part={props.part2}></Part>
      <Part exercise={props.exercises3} part={props.part3}></Part>
    </div>
  )
}
